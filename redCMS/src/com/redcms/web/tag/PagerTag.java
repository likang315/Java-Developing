...
public class PagerTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException 
	{
	    ...
	    if(page.getPageNo()-1<1)
	    	sb.append("<a href='"+url+"?pageNo=1&"+param+"'  class='btn btn-white' type='button'><i class='fa fa-chevron-left'></i></a>");
	    else
	    	sb.append("<a href='"+url+"?pageNo="+(page.getPageNo()-1)+"&"+param+"'  class='btn btn-white' type='button'><i class='fa fa-chevron-left'></i></a>");	
