                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="admin/modelItem?action=channelList&ischannel=0&model_id=<%=m.getId()%>" class="btn btn-success">内容字段管理</a>
                                       <a href="admin/modelItem?action=channelList&ischannel=1&model_id=<%=m.getId()%>" class="btn btn-info">栏目字段管理</a>
                                    </td>
                                </tr>
                                		   <%
                                	   }
